  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap text-left lg:text-left">
      <div class="w-full lg:w-6/12 px-4">
        <h4 class="text-3xl fonat-semibold text-primaryBlue">Let's keep in touch!</h4>
      ...
      <div class="w-full lg:w-6/12 px-4">
        <div class="flex flex-wrap items-top mb-6">
          <div class="w-full lg:w-4/12 px-4 ml-auto">
            <span class="block uppercase text-primaryBlue text-sm font-semibold mb-2">Useful Links</span>
            <ul class="list-unstyled">
              <li>
                <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="#">About Us</a>
              </li>
              <li>
                <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="https://github.com/pvdkhoa/E-LearningWebsite/">Blog</a>
              </li>
              <li>
                <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" href="https://github.com/pvdkhoa/E-LearningWebsite/">Github</a>
              </li>
              <li>
          ...
          <div class="w-full lg:w-4/12 px-4">
            <span class="block uppercase text-primaryBlue text-sm font-semibold mb-2">Other Resources</span>
            <ul class="list-unstyled">
              <li>
    ...
    <div class="flex flex-wrap items-center md:justify-between justify-center">
      <div class="w-full md:w-4/12 px-4 mx-auto text-center">
        <div class="text-md font-semibold py-1">
          ...
          <a href="https://github.com/pvdkhoa/E-LearningWebsite/" class="text-blueGray-500 hover:text-primaryBlue">Creative by <span class="text-primaryBlue">ChayDoAn</span></a>.
        </div>
      </div>
    </div>
  </div>
